...
// Computer move
int comp_move(){
    std::random_device rd; // Random number generated from hardware 
    std::mt19937 gen(rd()); // mt19937: Mersenne Twister pseudo-random generator 
...
// Check full board using boolean function
